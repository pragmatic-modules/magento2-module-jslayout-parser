...
class ComponentTest extends TestCase
{
    ...
    {
        $componentFactory = $this->getMockBuilder(ComponentInterfaceFactory::class)->disableOriginalConstructor()->getMock();

        $componentFactory->expects($this->any())
            ->method('create')
            ->will($this->returnCallback(
                function ($component) use ($componentFactory) {
                    return new Component($componentFactory, (string)$component['componentName'], $component['data'], $component['parent'] ?? null);
                }
            ));
